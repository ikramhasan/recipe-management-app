...
Serializer<GFetchRecipeIndgredientsVars>
    _$gFetchRecipeIndgredientsVarsSerializer =
    new _$GFetchRecipeIndgredientsVarsSerializer();
...
class _$GFetchRecipeIndgredientsVarsSerializer
    implements StructuredSerializer<GFetchRecipeIndgredientsVars> {
  @override
  final Iterable<Type> types = const [
    GFetchRecipeIndgredientsVars,
    _$GFetchRecipeIndgredientsVars
  ];
  @override
  final String wireName = 'GFetchRecipeIndgredientsVars';

  @override
  Iterable<Object> serialize(
      Serializers serializers, GFetchRecipeIndgredientsVars object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[];
  ...
  @override
  GFetchRecipeIndgredientsVars deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GFetchRecipeIndgredientsVarsBuilder();
...
class _$GFetchRecipeIndgredientsVars extends GFetchRecipeIndgredientsVars {
  @override
  final _i2.Gingredients_bool_exp where;

  factory _$GFetchRecipeIndgredientsVars(
          [void Function(GFetchRecipeIndgredientsVarsBuilder) updates]) =>
      (new GFetchRecipeIndgredientsVarsBuilder()..update(updates)).build();

  _$GFetchRecipeIndgredientsVars._({this.where}) : super._();

  @override
  GFetchRecipeIndgredientsVars rebuild(
          void Function(GFetchRecipeIndgredientsVarsBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GFetchRecipeIndgredientsVarsBuilder toBuilder() =>
      new GFetchRecipeIndgredientsVarsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GFetchRecipeIndgredientsVars && where == other.where;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GFetchRecipeIndgredientsVars')
          ..add('where', where))
        .toString();
  }
}

class GFetchRecipeIndgredientsVarsBuilder
    implements
        Builder<GFetchRecipeIndgredientsVars,
            GFetchRecipeIndgredientsVarsBuilder> {
  _$GFetchRecipeIndgredientsVars _$v;
  ...
  GFetchRecipeIndgredientsVarsBuilder get _$this {
    if (_$v != null) {
  ...
  @override
  void replace(GFetchRecipeIndgredientsVars other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$GFetchRecipeIndgredientsVars;
  }

  @override
  void update(void Function(GFetchRecipeIndgredientsVarsBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$GFetchRecipeIndgredientsVars build() {
    _$GFetchRecipeIndgredientsVars _$result;
    try {
      _$result =
          _$v ?? new _$GFetchRecipeIndgredientsVars._(where: _where?.build());
    } catch (_) {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GFetchRecipeIndgredientsVars', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
