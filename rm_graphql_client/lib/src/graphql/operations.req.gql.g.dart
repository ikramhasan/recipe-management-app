...
Serializer<GFetchRecipeIndgredientsReq>
    _$gFetchRecipeIndgredientsReqSerializer =
    new _$GFetchRecipeIndgredientsReqSerializer();
...
class _$GFetchRecipeIndgredientsReqSerializer
    implements StructuredSerializer<GFetchRecipeIndgredientsReq> {
  @override
  final Iterable<Type> types = const [
    GFetchRecipeIndgredientsReq,
    _$GFetchRecipeIndgredientsReq
  ];
  @override
  final String wireName = 'GFetchRecipeIndgredientsReq';

  @override
  Iterable<Object> serialize(
      Serializers serializers, GFetchRecipeIndgredientsReq object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[
      'vars',
      serializers.serialize(object.vars,
          specifiedType: const FullType(_i3.GFetchRecipeIndgredientsVars)),
      'operation',
      serializers.serialize(object.operation,
          specifiedType: const FullType(_i4.Operation)),
    ];
    ...
    if (object.optimisticResponse != null) {
      result
        ..add('optimisticResponse')
        ..add(serializers.serialize(object.optimisticResponse,
            specifiedType: const FullType(_i2.GFetchRecipeIndgredientsData)));
    }
    if (object.updateCacheHandlerKey != null) {
      result
        ..add('updateCacheHandlerKey')
  ...
  @override
  GFetchRecipeIndgredientsReq deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GFetchRecipeIndgredientsReqBuilder();
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'vars':
          result.vars.replace(serializers.deserialize(value,
                  specifiedType:
                      const FullType(_i3.GFetchRecipeIndgredientsVars))
              as _i3.GFetchRecipeIndgredientsVars);
          break;
        case 'operation':
          result.operation = serializers.deserialize(value,
              specifiedType: const FullType(_i4.Operation)) as _i4.Operation;
        ...
        case 'optimisticResponse':
          result.optimisticResponse.replace(serializers.deserialize(value,
                  specifiedType:
                      const FullType(_i2.GFetchRecipeIndgredientsData))
              as _i2.GFetchRecipeIndgredientsData);
          break;
        case 'updateCacheHandlerKey':
          result.updateCacheHandlerKey = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
...
class _$GFetchRecipeIndgredientsReq extends GFetchRecipeIndgredientsReq {
  @override
  final _i3.GFetchRecipeIndgredientsVars vars;
  @override
  final _i4.Operation operation;
  @override
  final String requestId;
  @override
  final _i2.GFetchRecipeIndgredientsData Function(
          _i2.GFetchRecipeIndgredientsData, _i2.GFetchRecipeIndgredientsData)
      updateResult;
  @override
  final _i2.GFetchRecipeIndgredientsData optimisticResponse;
  @override
  final String updateCacheHandlerKey;
  @override
  final Map<String, dynamic> updateCacheHandlerContext;
  ...
  factory _$GFetchRecipeIndgredientsReq(
          [void Function(GFetchRecipeIndgredientsReqBuilder) updates]) =>
      (new GFetchRecipeIndgredientsReqBuilder()..update(updates)).build();

  _$GFetchRecipeIndgredientsReq._(
      {this.vars,
      this.operation,
      this.requestId,
      this.updateResult,
      ...
      : super._() {
    if (vars == null) {
      throw new BuiltValueNullFieldError('GFetchRecipeIndgredientsReq', 'vars');
    }
    if (operation == null) {
      throw new BuiltValueNullFieldError(
          'GFetchRecipeIndgredientsReq', 'operation');
    }
  }

  @override
  GFetchRecipeIndgredientsReq rebuild(
          void Function(GFetchRecipeIndgredientsReqBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GFetchRecipeIndgredientsReqBuilder toBuilder() =>
      new GFetchRecipeIndgredientsReqBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    final dynamic _$dynamicOther = other;
    return other is GFetchRecipeIndgredientsReq &&
        vars == other.vars &&
        operation == other.operation &&
        requestId == other.requestId &&
        updateResult == _$dynamicOther.updateResult &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GFetchRecipeIndgredientsReq')
          ..add('vars', vars)
          ..add('operation', operation)
          ..add('requestId', requestId)
          ..add('updateResult', updateResult)
...
class GFetchRecipeIndgredientsReqBuilder
    implements
        Builder<GFetchRecipeIndgredientsReq,
            GFetchRecipeIndgredientsReqBuilder> {
  _$GFetchRecipeIndgredientsReq _$v;

  _i3.GFetchRecipeIndgredientsVarsBuilder _vars;
  _i3.GFetchRecipeIndgredientsVarsBuilder get vars =>
      _$this._vars ??= new _i3.GFetchRecipeIndgredientsVarsBuilder();
  set vars(_i3.GFetchRecipeIndgredientsVarsBuilder vars) => _$this._vars = vars;
  ...
  _i2.GFetchRecipeIndgredientsData Function(
          _i2.GFetchRecipeIndgredientsData, _i2.GFetchRecipeIndgredientsData)
      _updateResult;
  _i2.GFetchRecipeIndgredientsData Function(
          _i2.GFetchRecipeIndgredientsData, _i2.GFetchRecipeIndgredientsData)
  ...
  set updateResult(
          _i2.GFetchRecipeIndgredientsData Function(
                  _i2.GFetchRecipeIndgredientsData,
                  _i2.GFetchRecipeIndgredientsData)
              updateResult) =>
      _$this._updateResult = updateResult;

  _i2.GFetchRecipeIndgredientsDataBuilder _optimisticResponse;
  _i2.GFetchRecipeIndgredientsDataBuilder get optimisticResponse =>
      _$this._optimisticResponse ??=
          new _i2.GFetchRecipeIndgredientsDataBuilder();
  set optimisticResponse(
          _i2.GFetchRecipeIndgredientsDataBuilder optimisticResponse) =>
      _$this._optimisticResponse = optimisticResponse;
  ...
  GFetchRecipeIndgredientsReqBuilder() {
    GFetchRecipeIndgredientsReq._initializeBuilder(this);
  }

  GFetchRecipeIndgredientsReqBuilder get _$this {
    if (_$v != null) {
      _vars = _$v.vars?.toBuilder();
      _operation = _$v.operation;
      _requestId = _$v.requestId;
  ...
  @override
  void replace(GFetchRecipeIndgredientsReq other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$GFetchRecipeIndgredientsReq;
  }

  @override
  void update(void Function(GFetchRecipeIndgredientsReqBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$GFetchRecipeIndgredientsReq build() {
    _$GFetchRecipeIndgredientsReq _$result;
    try {
      _$result = _$v ??
          new _$GFetchRecipeIndgredientsReq._(
              vars: vars.build(),
              operation: operation,
              requestId: requestId,
              updateResult: updateResult,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GFetchRecipeIndgredientsReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
