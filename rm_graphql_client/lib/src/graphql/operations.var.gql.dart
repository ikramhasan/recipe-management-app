...
abstract class GFetchRecipeIndgredientsVars
    implements
        Built<GFetchRecipeIndgredientsVars,
            GFetchRecipeIndgredientsVarsBuilder> {
  GFetchRecipeIndgredientsVars._();

  factory GFetchRecipeIndgredientsVars(
          [Function(GFetchRecipeIndgredientsVarsBuilder b) updates]) =
      _$GFetchRecipeIndgredientsVars;

  @nullable
  _i2.Gingredients_bool_exp get where;
  static Serializer<GFetchRecipeIndgredientsVars> get serializer =>
      _$gFetchRecipeIndgredientsVarsSerializer;
  Map<String, dynamic> toJson() => _i1.serializers
      .serializeWith(GFetchRecipeIndgredientsVars.serializer, this);
  static GFetchRecipeIndgredientsVars fromJson(Map<String, dynamic> json) =>
      _i1.serializers
          .deserializeWith(GFetchRecipeIndgredientsVars.serializer, json);
}
