...
Serializer<GFetchRecipeIndgredientsData>
    _$gFetchRecipeIndgredientsDataSerializer =
    new _$GFetchRecipeIndgredientsDataSerializer();
Serializer<GFetchRecipeIndgredientsData_ingredients>
    _$gFetchRecipeIndgredientsDataIngredientsSerializer =
    new _$GFetchRecipeIndgredientsData_ingredientsSerializer();
...
class _$GFetchRecipeIndgredientsDataSerializer
    implements StructuredSerializer<GFetchRecipeIndgredientsData> {
  @override
  final Iterable<Type> types = const [
    GFetchRecipeIndgredientsData,
    _$GFetchRecipeIndgredientsData
  ];
  @override
  final String wireName = 'GFetchRecipeIndgredientsData';

  @override
  Iterable<Object> serialize(
      Serializers serializers, GFetchRecipeIndgredientsData object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[
      '__typename',
      serializers.serialize(object.G__typename,
      ...
      serializers.serialize(object.ingredients,
          specifiedType: const FullType(BuiltList, const [
            const FullType(GFetchRecipeIndgredientsData_ingredients)
          ])),
    ];
  ...
  @override
  GFetchRecipeIndgredientsData deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GFetchRecipeIndgredientsDataBuilder();
...
class _$GFetchRecipeIndgredientsData_ingredientsSerializer
    implements StructuredSerializer<GFetchRecipeIndgredientsData_ingredients> {
  @override
  final Iterable<Type> types = const [
    GFetchRecipeIndgredientsData_ingredients,
    _$GFetchRecipeIndgredientsData_ingredients
  ];
  @override
  final String wireName = 'GFetchRecipeIndgredientsData_ingredients';

  @override
  Iterable<Object> serialize(
      Serializers serializers, GFetchRecipeIndgredientsData_ingredients object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[
      'id',
      serializers.serialize(object.id, specifiedType: const FullType(int)),
  ...
  @override
  GFetchRecipeIndgredientsData_ingredients deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GFetchRecipeIndgredientsData_ingredientsBuilder();
...
class _$GFetchRecipeIndgredientsData extends GFetchRecipeIndgredientsData {
  @override
  final String G__typename;
  @override
  final BuiltList<GFetchRecipeIndgredientsData_ingredients> ingredients;

  factory _$GFetchRecipeIndgredientsData(
          [void Function(GFetchRecipeIndgredientsDataBuilder) updates]) =>
      (new GFetchRecipeIndgredientsDataBuilder()..update(updates)).build();

  _$GFetchRecipeIndgredientsData._({this.G__typename, this.ingredients})
      : super._() {
    if (G__typename == null) {
      throw new BuiltValueNullFieldError(
          'GFetchRecipeIndgredientsData', 'G__typename');
    }
    if (ingredients == null) {
      throw new BuiltValueNullFieldError(
          'GFetchRecipeIndgredientsData', 'ingredients');
    }
  }

  @override
  GFetchRecipeIndgredientsData rebuild(
          void Function(GFetchRecipeIndgredientsDataBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GFetchRecipeIndgredientsDataBuilder toBuilder() =>
      new GFetchRecipeIndgredientsDataBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GFetchRecipeIndgredientsData &&
        G__typename == other.G__typename &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GFetchRecipeIndgredientsData')
          ..add('G__typename', G__typename)
...
class GFetchRecipeIndgredientsDataBuilder
    implements
        Builder<GFetchRecipeIndgredientsData,
            GFetchRecipeIndgredientsDataBuilder> {
  _$GFetchRecipeIndgredientsData _$v;

  String _G__typename;
  String get G__typename => _$this._G__typename;
  set G__typename(String G__typename) => _$this._G__typename = G__typename;

  ListBuilder<GFetchRecipeIndgredientsData_ingredients> _ingredients;
  ListBuilder<GFetchRecipeIndgredientsData_ingredients> get ingredients =>
      _$this._ingredients ??=
          new ListBuilder<GFetchRecipeIndgredientsData_ingredients>();
  set ingredients(
          ListBuilder<GFetchRecipeIndgredientsData_ingredients> ingredients) =>
      _$this._ingredients = ingredients;

  GFetchRecipeIndgredientsDataBuilder() {
    GFetchRecipeIndgredientsData._initializeBuilder(this);
  }

  GFetchRecipeIndgredientsDataBuilder get _$this {
    if (_$v != null) {
      _G__typename = _$v.G__typename;
  ...
  @override
  void replace(GFetchRecipeIndgredientsData other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$GFetchRecipeIndgredientsData;
  }

  @override
  void update(void Function(GFetchRecipeIndgredientsDataBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$GFetchRecipeIndgredientsData build() {
    _$GFetchRecipeIndgredientsData _$result;
    try {
      _$result = _$v ??
          new _$GFetchRecipeIndgredientsData._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GFetchRecipeIndgredientsData', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$GFetchRecipeIndgredientsData_ingredients
    extends GFetchRecipeIndgredientsData_ingredients {
  @override
  final int id;
  @override
  final String name;
  ...
  factory _$GFetchRecipeIndgredientsData_ingredients(
          [void Function(GFetchRecipeIndgredientsData_ingredientsBuilder)
              updates]) =>
      (new GFetchRecipeIndgredientsData_ingredientsBuilder()..update(updates))
          .build();

  _$GFetchRecipeIndgredientsData_ingredients._(
      {this.id, this.name, this.recipe_id, this.G__typename})
      : super._() {
    if (id == null) {
      throw new BuiltValueNullFieldError(
          'GFetchRecipeIndgredientsData_ingredients', 'id');
    }
    if (name == null) {
      throw new BuiltValueNullFieldError(
          'GFetchRecipeIndgredientsData_ingredients', 'name');
    }
    if (recipe_id == null) {
      throw new BuiltValueNullFieldError(
          'GFetchRecipeIndgredientsData_ingredients', 'recipe_id');
    }
    if (G__typename == null) {
      throw new BuiltValueNullFieldError(
          'GFetchRecipeIndgredientsData_ingredients', 'G__typename');
    }
  }

  @override
  GFetchRecipeIndgredientsData_ingredients rebuild(
          void Function(GFetchRecipeIndgredientsData_ingredientsBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GFetchRecipeIndgredientsData_ingredientsBuilder toBuilder() =>
      new GFetchRecipeIndgredientsData_ingredientsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GFetchRecipeIndgredientsData_ingredients &&
        id == other.id &&
        name == other.name &&
...
class GFetchRecipeIndgredientsData_ingredientsBuilder
    implements
        Builder<GFetchRecipeIndgredientsData_ingredients,
            GFetchRecipeIndgredientsData_ingredientsBuilder> {
  _$GFetchRecipeIndgredientsData_ingredients _$v;
  ...
  GFetchRecipeIndgredientsData_ingredientsBuilder() {
    GFetchRecipeIndgredientsData_ingredients._initializeBuilder(this);
  }

  GFetchRecipeIndgredientsData_ingredientsBuilder get _$this {
    if (_$v != null) {
      _id = _$v.id;
      _name = _$v.name;
  ...
  @override
  void replace(GFetchRecipeIndgredientsData_ingredients other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$GFetchRecipeIndgredientsData_ingredients;
  }

  @override
  void update(
      void Function(GFetchRecipeIndgredientsData_ingredientsBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$GFetchRecipeIndgredientsData_ingredients build() {
    final _$result = _$v ??
        new _$GFetchRecipeIndgredientsData_ingredients._(
