...
abstract class GFetchRecipeIndgredientsReq
    implements
        Built<GFetchRecipeIndgredientsReq, GFetchRecipeIndgredientsReqBuilder>,
        _i1.OperationRequest<_i2.GFetchRecipeIndgredientsData,
            _i3.GFetchRecipeIndgredientsVars> {
  GFetchRecipeIndgredientsReq._();

  factory GFetchRecipeIndgredientsReq(
          [Function(GFetchRecipeIndgredientsReqBuilder b) updates]) =
      _$GFetchRecipeIndgredientsReq;

  static void _initializeBuilder(GFetchRecipeIndgredientsReqBuilder b) => b
    ..operation = _i4.Operation(
        document: _i5.document, operationName: 'FetchRecipeIndgredients')
    ..executeOnListen = true;
  _i3.GFetchRecipeIndgredientsVars get vars;
  _i4.Operation get operation;
  _i4.Request get execRequest =>
      _i4.Request(operation: operation, variables: vars.toJson());
  @nullable
  ...
  _i2.GFetchRecipeIndgredientsData Function(
      ...
      get updateResult;
  @nullable
  _i2.GFetchRecipeIndgredientsData get optimisticResponse;
  @nullable
  String get updateCacheHandlerKey;
  @nullable
  Map<String, dynamic> get updateCacheHandlerContext;
  ...
  bool get executeOnListen;
  @override
  _i2.GFetchRecipeIndgredientsData parseData(Map<String, dynamic> json) =>
      _i2.GFetchRecipeIndgredientsData.fromJson(json);
  static Serializer<GFetchRecipeIndgredientsReq> get serializer =>
      _$gFetchRecipeIndgredientsReqSerializer;
  Map<String, dynamic> toJson() => _i6.serializers
      .serializeWith(GFetchRecipeIndgredientsReq.serializer, this);
  static GFetchRecipeIndgredientsReq fromJson(Map<String, dynamic> json) =>
      _i6.serializers
          .deserializeWith(GFetchRecipeIndgredientsReq.serializer, json);
}
