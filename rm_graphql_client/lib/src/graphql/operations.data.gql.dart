...
abstract class GFetchRecipeIndgredientsData
    implements
        Built<GFetchRecipeIndgredientsData,
            GFetchRecipeIndgredientsDataBuilder> {
  GFetchRecipeIndgredientsData._();

  factory GFetchRecipeIndgredientsData(
          [Function(GFetchRecipeIndgredientsDataBuilder b) updates]) =
      _$GFetchRecipeIndgredientsData;

  static void _initializeBuilder(GFetchRecipeIndgredientsDataBuilder b) =>
      b..G__typename = 'query_root';
  @BuiltValueField(wireName: '__typename')
  String get G__typename;
  BuiltList<GFetchRecipeIndgredientsData_ingredients> get ingredients;
  static Serializer<GFetchRecipeIndgredientsData> get serializer =>
      _$gFetchRecipeIndgredientsDataSerializer;
  Map<String, dynamic> toJson() => _i1.serializers
      .serializeWith(GFetchRecipeIndgredientsData.serializer, this);
  static GFetchRecipeIndgredientsData fromJson(Map<String, dynamic> json) =>
      _i1.serializers
          .deserializeWith(GFetchRecipeIndgredientsData.serializer, json);
}

abstract class GFetchRecipeIndgredientsData_ingredients
    implements
        Built<GFetchRecipeIndgredientsData_ingredients,
            GFetchRecipeIndgredientsData_ingredientsBuilder> {
  GFetchRecipeIndgredientsData_ingredients._();

  factory GFetchRecipeIndgredientsData_ingredients(
      [Function(GFetchRecipeIndgredientsData_ingredientsBuilder b)
          updates]) = _$GFetchRecipeIndgredientsData_ingredients;

  static void _initializeBuilder(
          GFetchRecipeIndgredientsData_ingredientsBuilder b) =>
  ...
  @BuiltValueField(wireName: '__typename')
  String get G__typename;
  static Serializer<GFetchRecipeIndgredientsData_ingredients> get serializer =>
      _$gFetchRecipeIndgredientsDataIngredientsSerializer;
  Map<String, dynamic> toJson() => _i1.serializers
      .serializeWith(GFetchRecipeIndgredientsData_ingredients.serializer, this);
  static GFetchRecipeIndgredientsData_ingredients fromJson(
          Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(
          GFetchRecipeIndgredientsData_ingredients.serializer, json);
}
